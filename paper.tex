...
other position via attention; we measure three specific source--consumer pairs out of many
possible ones, and make no claim about pairs we did not test.

We report three sets of measurements:
...
\section{Layer-pair sweep}
\label{sec:layer-sweep-appendix}
